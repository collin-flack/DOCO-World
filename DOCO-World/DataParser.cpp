					...
					while (getNextLine(line, 127))
					{
						...
						if (strcmp(line, "<MOVEMENT>") == 0)
						{
							...
							if (getNextLine(line, 127))
							{
								...
								if (strcmp(line, "VERTICAL") == 0) {

									movementInts.push_back(1); 

								}

								else if (strcmp(line, "HORIZONTAL") == 0) {

									movementInts.push_back(2); 

								}

								else if (strcmp(line, "DIAGONAL") == 0) {

									movementInts.push_back(3); 
...
vector<int> DataParser::getMovementInts()
{
	return movementInts;
}
